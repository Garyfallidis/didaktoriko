...
\caption{QuickBundles centroids of the largest 100 clusters for 10 subjects. Full tractographies are also presented using high transparency in order to create a "looking glass" effect. \label{Flo:BAs}}
\end{figure*}
...
\par\end{centering}
\caption{Bundle Adjacencies of for the 45 pairings of 10 subjects with different distance thresholds. \label{Flo:BAs}}
\end{figure}
