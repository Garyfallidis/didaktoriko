...
\STATE \# append to current cluster
	\IF{$\texttt{flip}_{l}$ is $1$} 
		\STATE $c_{l}.h \leftarrow c_{l}.h + \textbf{reverse}(\textbf{t})$
	\ELSE
		\STATE $c_{l}.h \leftarrow c_{l}.h + \textbf{t}$
	\ENDIF
...
QB clustering to the 10 PBC data sets (\ref{sub:QB-Data-sets}). The mean
...
\subsection{Consistency of QB \label{sub:Comparisons}}
...
of 200:1 while preserving characteristic information about the
tractography.
