...
$\num{4149.2}$ ($\pm \num{831.0}$). There is therefore a considerable
...
correlation between number of QB clusters and full tractography size was
calculated (r=0.867, N=10, threshold=10~mm). The correlation with full
tractography size only drops to r=0.786 when the clustering was
performed on a random samples of fixed size ($\num{80000}$).  This
