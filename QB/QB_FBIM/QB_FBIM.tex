...
across tractographies. Bearing in mind that large subsets of
tractography streamlines appear more as continuously varying shapes
rather than discrete clusters, we compare this with the result of
dividing a medium into slices of equal thickness. Depending on the
...
with a mean OMA of 75\%. we tried to quantify the worst and best case
scenarios we use fullowing analogy - parallel lines of uniform density -
50\% is not chance and comes from the fact that both `systems' are
subdivisions of the medium that ...
...
\num{10000}[?? Elef to check]) and applied their clustering algorithms to those. We have
...
more uniformly distributed in this space and thus a better compression
of the original dataset. We quantify this using the coverage and overlap
statistics (\ref{sub:Tightness-comparisons-1}).
...
\hline
\multirow{2}{*}{$10$~mm/$10$~mm} & Centroids & 99.96 (0.007) & 4.99* (0.10*)\\   
& Random & 99.96 (0.007) & 4.99* (0.10*)\\   
\hline
\multirow{2}{*}{$20$~mm/$20$~mm} & Centroids & 99.96 (0.007) & 4.99* (0.10*)\\   
& Random & 99.96 (0.007) & 4.99* (0.10*)\\   
\hline   
\end{tabular}
\end{table}
...
Thresholds & Comparison & Coverage \% (s.d.) & Overlap (s.d.) \\
\hline
\multirow{2}{*}{$10$~mm/$10$~mm} & Original & 99.96 (0.007) & 4.99* (0.10*)\\   
& Other half & 99.96 (0.007) & 4.99* (0.10*)\\   
\hline
\multirow{2}{*}{$20$~mm/$20$~mm} & Original & 99.96 (0.007) & 4.99* (0.10*)\\   
& Other half & 99.96 (0.007) & 4.99* (0.10*)\\
\hline   
\end{tabular}
\end{table}
