...
For this purpose we evaluated BA~(\ref{eq:TC}) between pairs of these $10$ warped tractographies. This generated ${10}\choose{2}$=$45$ BA values with $\theta=10$~mm. We also generated another $45$ BA values with $\theta=20$~mm.  
