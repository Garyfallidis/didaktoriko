...
follows. Let us assume that we have gathered the centroid streamlines from
...
averaged. Across subjects the mean matched agreement was 74\% (s.d.~0.39\%).

\textbf{Split half results for QB centroids vs. equivalent random
  subsets of streamlines}
