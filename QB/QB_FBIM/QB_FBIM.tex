...
[B - these figures were originally from the thesis but I feel the
need to recalculate them!] Next we investigated how consistent QB
clusterings are when data sets are re-ordered. Twelve different random
...
compared using the optimized matched agreements index and then
...
[all these relculations will be done using to QB results of the
reorderings as the basis for ODA, coverage, overlap statistics.]

Some authors (e.g.~O'Donnell;Visser) 
