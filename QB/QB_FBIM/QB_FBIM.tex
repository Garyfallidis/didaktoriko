...
is therefore a considerable between-subject variation in this
parameter. By contrast the within-subject variability of the number of
clusters across random orderings is rather small, with mean standard
deviation $12.7$ (min $7.3$; max $17.4$). While this suggests an
encouraging level of robustness in terms of the numbers of clusters that
QB creates it does not address the question of how similar the various
clusterings were.

\citet{moberts2005evaluation} compared three flavours of hierarchical
clustering and shared nearest neighbour in terms of their performance
against a `gold standard'. This was three tractographies of between   labelling of the 

\textbf{need to add some }
...
\begin{figure}
\begin{centering}
\includegraphics[scale=0.2]{Figures/Fig_13_BAs}
\par\end{centering}
\caption{Bundle Adjacencies for the 45 pairings of 10 subjects with different distance thresholds. \label{Flo:BAs}}
\end{figure}
