...
are likely to relate to parts of the Corpus Callosum [???]  while the
green clusters indicate parts of the Cingulum [???]. Further interaction
with the data via the QB clustering will be required to achieve fuller
identification of any corresponding neural tracts . We have already
