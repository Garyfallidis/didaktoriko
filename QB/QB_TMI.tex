...
QuickBundles (QB) is a surprisingly simple, very fast algorithm which
can reduce tractography representation to an accessible structure in a
time that is linear in the number of tracks $N$; it is an extended
...
have $|C|$ clusters. Select the first track $s_{1}$ and place it in
the first cluster $c_{1}\leftarrow(\{1\},s_{1},1)$.  Obviously $|C|
