...
complexity of QB (\ref{sub:Complexity}) and about the robustness of QB
to changes in ordering of the tractography (\ref{sub:Comparisons}). Next
in \ref{QB_Representation} we demonstrate the high level of clarity and
...
tractography as input brings full tractogprhies within the effective
range of higher order clustering methods
