...
\thanks{M.M. Correia and I. Nimmo-Smith are with the MRC Cognition and Brain Sciences Unit, UK.}%
...
\begin{abstract}
  ...
  selected and the associated tracks re-clustered in turn via QB. This allows one to explore the neuroanatomy directly. Alternatively the QB
...
\begin{figure}
\begin{centering}
\includegraphics[scale=0.6]{Fig_7_close_distance}
\par\end{centering}
